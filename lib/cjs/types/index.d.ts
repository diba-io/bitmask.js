...
export declare const getEncryptedWallet: (
  password: string,
  encrypted_descriptors: string
) => Promise<GetEncryptedWallet>;
export declare const getMnemonicSeed: (
  encryption_password: string,
  seed_password: string
) => Promise<GetMnemonicSeed>;
export declare const saveMnemonicSeed: (
  mnemonic: string,
  encryption_password: string,
  seed_password: string
) => Promise<SaveMnemonicSeed>;
export declare const getWalletData: (
  descriptor: string,
  change_descriptor?: string
) => Promise<GetWalletData>;
export declare const importAsset: (
  asset: string,
  utxo: string
) => Promise<ImportAsset>;
export declare const getBlindedUtxo: (
  utxo_string: string
) => Promise<GetBlindedUtxo>;
export declare const sendSats: (
  descriptor: string,
  change_descriptor: string,
  address: string,
  amount: bigint,
...
export declare const fundVault: (
  descriptor: string,
  change_descriptor: string,
  address: string,
  uda_address: string,
...
export declare const getAssetsVault: (
...
export declare const transferAssets: (
  descriptor_xpub: string,
  transfers: AssetTransfer[]
) => Promise<TransfersSerializeResponse>;
export declare const signPsbt: (
...
export declare const lnCreateWallet: (
  username: string,
  password: string
) => Promise<CreateWalletResponse>;
export declare const lnAuth: (
  username: string,
  password: string
) => Promise<AuthResponse>;
export declare const lnCreateInvoice: (
  description: string,
  amount: number,
  token: string
...
export declare const lnPayInvoice: (
  payment_request: string,
  token: string
) => Promise<PayInvoiceResponse>;
export declare const lnCheckPayment: (
  payment_hash: string
